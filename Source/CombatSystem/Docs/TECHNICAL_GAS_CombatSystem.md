...
## Nhật ký quyết định kỹ thuật (Technical decision log)
...
| **Hot Reload** có thể sinh `HOTRELOAD_*` attribute | Tránh bind asset vào bản tạm; build sạch + mở editor lại khi lỗi reference. |

*(Có thể bổ sung dòng mới mỗi khi đổi spec hoặc thư viện — tương tự release notes.)*

---

## Ghi chú code / dự án

- Cách cài / chạy: xem **README** của repo (nếu có).
